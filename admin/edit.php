...
<body class="inter-body learning-color">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="header-bottom header-bottom-2">
                        <h2 class="fw-500 text-white">Edit Quotes</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="acount-form-box">
                        <form class="form-style-1" action ="f_edit.php" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                                <input type="text" name="judul" id="" value="<?php echo $post["judul"]; ?>" class="form-control" >
                            </div>
                            <div class="mb-3">
                                <textarea name="isi" class="form-control" placeholder="Enter Your Bio" rows="3"><?php echo $post["isi"]; ?></textarea>
                            </div>
                            <input type="hidden" name="id" value="<?php echo $id; ?>">
                            <input name="ok" type="submit" value="Update" class="btn btn-md btn-gradient mb-4"></input>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <!-- image change js -->
    <script src="https://themes.pixelstrap.net/multikit/assets/js/image-change.js"></script>
