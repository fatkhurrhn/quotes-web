            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="header-bottom header-bottom-2">
                        <h2 class="fw-500 text-white">Tambah Quotes</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="acount-form-box">
                        <form class="form-style-1" action="f_tambah.php" method="POST">
                            <div class="mb-3">
                                <input type="text" name="judul" id="" class="form-control" placeholder="Enter Your Name">
                            </div>
                            <div class="mb-3">
                                <textarea name="isi" class="form-control" placeholder="Enter Your Quotes..." rows="3"></textarea>
                            </div>
                            <input type="submit" value="Submit" class="btn btn-md btn-gradient mb-4"></input>
                        </form>
                    </div>
                </div>
            </div>
